  ...
  module ENI
    ...
    def environment
      @environment ||= {}.tap do |env|
        ...
        unless env[:vpc_id]
          raise Errors::EnvironmentError, 'Unable to detect VPC settings, library incompatible with EC2-Classic'
        end
      end.freeze
    ...
    def create_interface(options = {})
      ...
      wait_for 'the interface to be created', rescue: EC2::Errors::ServiceError do
    ...
    def detach_interface(id, options = {})
      ...
      unless interface = response[:network_interfaces].first
    ...
    def unassign_secondary_ip(private_ip, options = {})
      ...
      unless interface = resp[:network_interfaces].first
        raise Errors::UnknownInterface, "Interface #{device.interface_id} could not be located"
      end
    ...
    def assert_ifconfig_access
      raise Errors::InterfacePermissionError, 'Insufficient user priveleges to configure network interfaces' unless can_modify_ifconfig?
    end
    ...
    def can_access_ec2?
      ...
      test_methods.each do |method, params|
        begin
          ...
          raise Errors::ClientOperationError, 'Unexpected behavior while testing AWS API access'
    ...
    def assert_ec2_access
      raise Errors::ClientPermissionError, 'Insufficient access to EC2 operations for network interface modification' unless can_access_ec2?
    end
